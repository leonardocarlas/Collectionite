...
public class ApiRequest {
     ...
     * @param appSecret
     */
    public ApiRequest(String appToken, String appSecret) {
    ...
    public boolean request(String requestURL) {
        ...
        try {
            ...
            Map<String, String> unsortedParameters = new HashMap<>();
            ...
            Map<String, String> sortedParameters = new TreeMap<>(unsortedParameters);
            ...
            //Removed the code 401 and 404 in order to print every error in TestMain.java
            if (200 == _lastCode /*|| 401 == _lastCode || 404 == _lastCode*/) {
                BufferedReader rd = new BufferedReader(new InputStreamReader(_lastCode==200?connection.
